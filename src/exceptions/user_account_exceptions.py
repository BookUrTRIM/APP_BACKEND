...
class UserAccountNotFound(NotFound):
    ...
    def __init__(self, detail: str = "Compte utilisateur introuvable."):
...
class InvalidUserAccountData(BadRequest):
    ...
    def __init__(self, detail: str = "Les données du compte utilisateur sont invalides."):
        super().__init__(detail=detail)
...
class EmailAlreadyExists(Conflict):
    ...
    def __init__(self, detail: str = "Un compte avec cet email existe déjà."):
        super().__init__(detail=detail)
...
class UserAccountDeactivated(Forbidden):
    ...
    def __init__(self, detail: str = "Ce compte a été désactivé."):
        super().__init__(detail=detail)
...
class UserAccountAccessDenied(Forbidden):
    ...
    def __init__(self, detail: str = "Accès refusé à ce compte utilisateur."):
        super().__init__(detail=detail)
