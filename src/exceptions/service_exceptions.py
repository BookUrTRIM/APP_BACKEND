...
class ServiceNotFound(NotFound):
    ...
    def __init__(self, detail: str = "Prestation introuvable."):
...
class InvalidServiceData(BadRequest):
    ...
    def __init__(self, detail: str = "Les données de la prestation sont invalides."):
        super().__init__(detail=detail)
...
class ServiceAccessDenied(Forbidden):
    ...
    def __init__(self, detail: str = "Accès refusé à cette prestation."):
        super().__init__(detail=detail)
