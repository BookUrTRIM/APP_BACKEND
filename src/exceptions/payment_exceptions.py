...
class PaymentNotFound(NotFound):
    ...
    def __init__(self, description: str = "Paiement introuvable."):
...
class InvalidPaymentData(BadRequest):
    ...
    def __init__(self, description: str = "Les données de paiement sont invalides."):
        super().__init__(description=description)
...
class PaymentAlreadyProcessed(Conflict):
    ...
    def __init__(self, description: str = "Ce paiement a déjà été traité."):
        super().__init__(description=description)


class DepositAlreadyPaid(Conflict):
    """Erreur levée lorsqu'un acompte a déjà été versé pour ce rendez-vous."""
    def __init__(self, description: str = "Un acompte a déjà été versé pour ce rendez-vous."):
        super().__init__(description=description)
...
class PaymentAccessDenied(Forbidden):
    ...
    def __init__(self, description: str = "Accès refusé à ce paiement."):
        super().__init__(description=description)
...
class PaymentFailed(InternalServerError):
    ...
    def __init__(self, description: str = "Le traitement du paiement a échoué."):
        super().__init__(description=description)
