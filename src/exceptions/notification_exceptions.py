...
class NotificationNotFound(NotFound):
    ...
    def __init__(self, detail: str = "Notification introuvable."):
...
class InvalidNotificationData(BadRequest):
    ...
    def __init__(self, detail: str = "Les données de la notification sont invalides."):
        super().__init__(detail=detail)


class InvalidNotificationType(BadRequest):
    """Erreur levée lorsque le type de notification est inconnu ou invalide."""
    def __init__(self, detail: str = "Type de notification invalide."):
        super().__init__(detail=detail)
...
class NotificationAccessDenied(Forbidden):
    ...
    def __init__(self, detail: str = "Accès refusé à cette notification."):
        super().__init__(detail=detail)
...
class NotificationCreationForbidden(Forbidden):
    ...
    def __init__(
            self,
            detail: str = "Vous ne pouvez pas créer de notifications sur d'autres comptes que le votre.",
    ):
        super().__init__(detail=detail)
...
class NotificationAlreadyViewed(Conflict):
    ...
    def __init__(self, detail: str = "Cette notification a déjà été marquée comme lue."):
        super().__init__(detail=detail)
...
class NotificationDispatchFailed(InternalServerError):
    ...
    def __init__(self, detail: str = "Impossible d'envoyer la notification."):
        super().__init__(detail=detail)
