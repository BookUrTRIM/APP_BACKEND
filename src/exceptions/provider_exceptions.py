...
class ProviderNotFound(NotFound):
    ...
    def __init__(self, detail: str = "Profil prestataire introuvable."):
...
class InvalidProviderData(BadRequest):
    ...
    def __init__(self, detail: str = "Les données du profil prestataire sont invalides."):
        super().__init__(detail=detail)
...
class ProviderAlreadyExists(Conflict):
    ...
    def __init__(self, detail: str = "Un profil prestataire existe déjà pour ce compte."):
        super().__init__(detail=detail)
