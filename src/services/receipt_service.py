...
class ReceiptService:
    @staticmethod
    def list_by_appointment(appointment_id: int) -> List[ReceiptResponseDTO]:
        if not AppointmentRepository.get_by_id(appointment_id):
            raise AppointmentNotFound()
        receipts = ReceiptRepository.list_by_appointment(appointment_id)
